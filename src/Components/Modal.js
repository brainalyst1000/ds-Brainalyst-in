...
const CurriculumModal = () => {
  ...
  const handleSubmit = (e) => {
    ...
    link.href = '/DATA-SCIENCE-360-Brochure.pdf';
  ...
  return (
    <>
      <Button variant="primary" onClick={handleShow} className='fixed-button' style={{background: '#007bff',fontSize: '14px',fontWeight: '600',position: 'fixed',right: '20px',bottom: '30px',zIndex: '1000',borderRadius: '5px',boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)',padding: '10px 20px'}}>
        Download Curriculum Brochure <i className="fa-solid fa-download"></i>
      </Button>

      <Modal show={show} onHide={handleClose} style={{marginTop: '65px'}}>
        <Modal.Header closeButton>
          <Modal.Title style={{color: '#121212'}}>Fill the Form to Download the Brochure</Modal.Title>
        </Modal.Header>
        <Modal.Body>
