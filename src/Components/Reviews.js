...
export const Review=()=>{
    return(
        <section className="review" id="review">
            <Container>
                <Row>
                    <div className="course-title"><h2>Student Reviews</h2></div><hr />
                    <Carousel>
                    <Carousel.Item>
                    <Col>
                    <Card>
                    ...
                    <div>
                        ...
                        <strong>Shriya Gond</strong>
                        <span style={{font: '13px'}}>7 months ago</span>
                    </div></div>
                    </div>
                    </Card>
                  </Col></Carousel.Item>
...
quality of education provided is excellent, and the faculty is top-notch. The instructors were
incredibly experienced and knowledgeable, and their teaching style created an interest in
learning.I had a wonderful experience with Brainalyst and looked forward to taking more courses with
them.</p></div>
                    <div>
                        <div style={{display: "flex",flexDirection: "column"}}>
                        <strong>Himanshu Chauhan</strong>
                        <span style={{font: '13px'}}>a year ago</span>
                    </div></div>
                    </div>
                    </Card>
                  </Col></Carousel.Item>
                  ...
                  <Col>
                    ...
                    <div>
                        <div style={{display: "flex",flexDirection: "column"}}>
                        <strong>Divyanshu Bhatt</strong>
                        <span style={{font: '13px'}}>9 months ago</span>
                    </div></div>
                    </div>
                    </Card>
                  </Col></Carousel.Item>
...
Learning with Brainalyst has proven to be quite helpful. They've effortlessly changed my experience of learning data science. I saw significant changes in my knowledge in Data Visualization using python. I've never before had such practical clarity on the subject matter. The complex topics were explained greatly with intuition and I've found them easier to grasp. The course layout is definitely a big part of my smooth experience. Not only that, the UI is very user/friendly, and I had an amazing experience
</p></div>
                    <div>
                        <div style={{display: "flex",flexDirection: "column"}}>
                        <strong>Shailesh Acharya</strong>
                        <span style={{font: '13px'}}>a year ago</span>
                    </div></div>
                    </div>
                    </Card>
                  ...
                  <Col>
                    ...
                    I was unsure about which R-learning course to select from the market. The finest Brainalyst was the one I chose, it turned out. The training was thorough, precise, and difficult but manageable. The teachers are excellent, going above and beyond to help the pupils understand the material. The assignments given were what actually contributed to clarifying the ideas and laying a solid foundation. I wholeheartedly urge everyone to learn data science using the R programming language.</p></div>
                    <div>
                        <div style={{display: "flex",flexDirection: "column"}}>
                        <strong>Deepanshi Yadav</strong>
                        <span style={{font: '13px'}}>a year ago</span>
                    </div></div>
                    </div>
                    </Card>
                  ...
                  <Col>
                    ...
                    <div>
                        <div style={{display: "flex",flexDirection: "column"}}>
                        <strong>Riyansh Sharma</strong>
                        <span style={{font: '13px'}}> two year ago</span>
                    </div></div>
                    </div>
                    </Card>
                  </Col></Carousel.Item>
